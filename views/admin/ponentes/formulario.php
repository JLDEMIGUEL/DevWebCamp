<fieldset class="formulario__fieldset">
    <legend class="formulario__legend">Informacion Persnal</legend>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="text" class="formulario__input" id="tags_input" placeholder="Ej: Node.js, PHP, Java, Python">
